...
for mouse in mice:
    ...
    for date in Dates:
        ...
        # plt.eventplot(multiplied_track_licks, colors='red', lineoffsets=10, label='lick')
        # plt.eventplot(multiplied_track_lever, colors='green', lineoffsets=10, label='leverpress/ sipper out')
        # plt.eventplot(multiplied_track_leverend, colors='blue', lineoffsets=10, label='end session')
        # plt.eventplot(multiplied_track_cue, colors='pink', lineoffsets=10, label='cue')
